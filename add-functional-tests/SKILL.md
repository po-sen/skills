...
description: "Add or improve functional (black-box) tests for an API or service by exercising real endpoints and verifying user-visible behavior. Use when the user asks for functional or end-to-end API tests."
---
